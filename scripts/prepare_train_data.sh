...
wget -P ../data/raw_train/unnatural_instructions/ https://github.com/orhonovich/unnatural-instructions/raw/main/../data/core_../data.zip
unzip ../data/raw_train/unnatural_instructions/core_../data.zip -d ../data/raw_train/unnatural_instructions/


echo "Downloading Stanford alpaca ../data..."
wget -P ../data/raw_train/stanford_alpaca/ https://github.com/tatsu-lab/stanford_alpaca/raw/main/alpaca_../data.json
...
wget -P ../data/raw_train/gpt4_alpaca/ https://github.com/Instruction-Tuning-with-GPT-4/GPT-4-LLM/raw/main/../data/alpaca_gpt4_../data.json
#wget -P ../data/raw_train/gpt4_alpaca/ https://github.com/Instruction-Tuning-with-GPT-4/GPT-4-LLM/blob/main/data/alpaca_gpt4_data.json
wget -P ../data/raw_train/gpt4_alpaca/ https://github.com/Instruction-Tuning-with-GPT-4/GPT-4-LLM/raw/main/../data/alpaca_gpt4_../data_zh.json


echo "Downloading the baize ../dataset..."
wget -P ../data/raw_train/baize/ https://github.com/project-baize/baize-chatbot/raw/main/../data/alpaca_chat_../data.json
wget -P ../data/raw_train/baize/ https://github.com/project-baize/baize-chatbot/raw/main/../data/medical_chat_../data.json
wget -P ../data/raw_train/baize/ https://github.com/project-baize/baize-chatbot/raw/main/../data/quora_chat_../data.json
wget -P ../data/raw_train/baize/ https://github.com/project-baize/baize-chatbot/raw/main/../data/stackoverflow_chat_../data.json


echo "Downloading ShareGPT ../dataset..."
wget -P ../data/raw_train/sharegpt/ https://huggingface.co/../datasets/anon8231489123/ShareGPT_Vicuna_unfiltered/resolve/main/HTML_cleaned_raw_../dataset/sg_90k_part1_html_cleaned.json
wget -P ../data/raw_train/sharegpt/ https://huggingface.co/../datasets/anon8231489123/ShareGPT_Vicuna_unfiltered/resolve/main/HTML_cleaned_raw_../dataset/sg_90k_part2_html_cleaned.json
...
python open_instruct/reformat_../datasets.py --raw_../data_dir ../data/raw_train/ --output_dir ../data/processed/
